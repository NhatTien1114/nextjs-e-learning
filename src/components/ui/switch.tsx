...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        // Đảm bảo có kích thước h-5 w-9, border, và màu nền rõ ràng
        ...
        "data-[state=checked]:bg-primary data-[state=unchecked]:bg-input", // Ăn theo màu cấu hình ở Bước 1
        className
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          // Nút tròn bên trong chuyển động
